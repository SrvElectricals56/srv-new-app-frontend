...
export function NotificationScreen({
  ...
  const pageContent = useAppPageContent((role === 'user' ? 'user' : 'electrician') as any, 'notifications');
...
const styles = StyleSheet.create({
  ...
  detailMeta: { flex: 1 },
  detailType: { color: '#10254A', fontSize: 13, fontWeight: '900' },
  detailTime: { color: '#64748B', fontSize: 12, fontWeight: '700', marginTop: 3 },
  detailTitle: { color: '#10254A', fontSize: 22, fontWeight: '900', lineHeight: 28 },
  detailBody: { color: '#41536F', fontSize: 14, lineHeight: 23, marginTop: 12 },
  detailDoneBtn: {
    marginTop: 22,
    borderRadius: 18,
    minHeight: 48,
  ...
  clearAllBtn: {
    ...
    paddingVertical: 7,
    backgroundColor: 'rgba(16,37,74,0.08)',
  },
  clearAllBtnDark: {
    backgroundColor: 'rgba(255,255,255,0.12)',
  },
