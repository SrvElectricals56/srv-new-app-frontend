...
export function NotificationScreen({
  ...
  if (selectedNotification) {
    ...
    return (
      ...
      >
        <LinearGradient
          colors={darkMode ? cb.heroDark : [cb.primaryDeep, cb.primary, '#8B5E4A']}
          start={{ x: 0, y: 0 }}
          end={{ x: 1, y: 1 }}
    ...
    <ScrollView
      ...
      refreshControl={
        <RefreshControl
          ...
          tintColor={CB_PRIMARY}
          colors={[CB_PRIMARY]}
          progressBackgroundColor={darkMode ? cb.darkSurface : cb.bg}
        />
      }
    >
      {/* Hero */}
...
const styles = StyleSheet.create({
  ...
  detailCardDark: {
    backgroundColor: cb.darkSurface,
  ...
  detailMeta: { flex: 1 },
  detailType: { color: cb.text, fontSize: 13, fontWeight: '900' },
  detailTime: { color: cb.muted, fontSize: 12, fontWeight: '700', marginTop: 3 },
  detailTitle: { color: cb.text, fontSize: 22, fontWeight: '900', lineHeight: 28 },
  detailBody: { color: cb.primaryInk, fontSize: 14, lineHeight: 23, marginTop: 12 },
  detailDoneBtn: {
    marginTop: 22,
    borderRadius: 18,
    minHeight: 48,
    backgroundColor: CB_DARK,
    alignItems: 'center',
    justifyContent: 'center',
  },
  ...
  listMoreBtn: {
    ...
    justifyContent: 'center',
    gap: 8,
    ...createShadow({ color: CB_PRIMARY, offsetY: 6, blur: 14, opacity: 0.12, elevation: 4 }),
  },
  listMoreBtnDark: { backgroundColor: '#F8FAFC' },
  listMoreText: { color: '#FFFFFF', fontSize: 13, fontWeight: '900' },
  listMoreTextDark: { color: CB_DARK },
  listMoreBadge: {
    minWidth: 24,
    height: 24,
    borderRadius: 12,
